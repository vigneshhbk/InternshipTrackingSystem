...
<head>
    ...
    <title>Professional | Student</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li><a href="stupers.php">Personal</a></li>
                        <li class="active"><a href="stuprof.php">Professional</a></li>
                        <li><a href="stuintern.php">Internships</a></li>
                        <li><a href="stuapp.php">Manage Applications</a></li>
    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
			<div><b>Student's Professional Details </b><br/> <br/>
			</div>
