...
<body>
	<script type="text/javascript">
		jQuery(document).ready(function(){
			...
			$.post('Filteradmininternship.php',{searchData:searchKeyword,citydata:cityKeyword} ,function (data){
    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
			...
			<input type="text" style="width:400px;" name="txtSearch" id="txtSearch" placeholder="Search by title, semester or business type"></input>
			<select id="ddlSearch" name ="ddlSearch">
				<option value="Title">Internship Name</option>
			...
			<input type="submit" id="btnadd" value="Add" onclick="window.location.href='admininternshipreg.php'"></input>
